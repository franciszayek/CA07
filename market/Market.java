...
import CA05.prod.pkg.order.OrderBook;
...
public class Market {
	...
	public void updateStockPrice(String symbol, double newPrice)
		...
		//As long as the symbol is not null and the price is valid, then the 
          	//stock price will be updated
		Stock updatedStock = removeStockFromStockList(symbol);
